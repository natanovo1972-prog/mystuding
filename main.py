...
def main():
    ...
    Пользователь выбирает файл для получения информации о транзакциях. Затем полученная информация
    фильтруется по статусу и сортируется по дате, возрастанию/убыванию, виду валюты. Также задается
    поиск по определенному слову в описании. Для написания кода использовались ранее написанные функции:
    итератор для транзакий по заданному валютному значению, функция подсчета банковских операций определенного
    типа с использованием библиотеки re, фильтрация операций по дате и по статусу выполнения, функция считывания
    файлов cvs и excel, функция получения информации по json-файлу, функция маскировки данных карты или счета,
    функция вывода даты транзакций с использованием библиотеки datetime."""
